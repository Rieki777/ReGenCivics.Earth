/**
 * Investment Form Page - Tripetto Form Embed for Investor Packet
...
import { ArrowLeft, Leaf, TrendingUp, Shield, Globe } from "lucide-react";
...
function MyceliumBackground() {
  return (
    ...
    >
      <defs>
        <radialGradient id="investGlow" cx="50%" cy="50%" r="50%">
  ...
  useEffect(() => {
    ...
    const initTripetto = async () => {
      try {
        ...
        // Initialize Tripetto form for investor packet
        ...
        if (window.TripettoStudio && window.TripettoAutoscroll) {
          ...
          window.TripettoStudio.form({
            ...
            token: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiSWxkM1NOZGdScWkzR2ZpZzZldDc0Z3VKTXlmZUJnTDg4M2Fra3Z0djJWRT0iLCJkZWZpbml0aW9uIjoiWVFhWFJqSXZSUXNpeUlOdzZibVZlRzFDeWtyR1prOHdxdC9ISEdJUnB0RT0iLCJ0eXBlIjoiY29sbGVjdCJ9.6ZHd4-_Ri2M2dYOSOFyFtf5_63vQUuYx3BBSK2PwTWs",
            element: "tripetto-x12u6"
            // Note: Redirect URL is configured in Tripetto Studio settings
          });
        }
      } catch (error) {
    ...
    return () => {
      ...
      const container = document.getElementById('tripetto-x12u6');
      if (container) {
        container.innerHTML = '';
      }
    };
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <h1 
              ...
              style={{ fontFamily: 'var(--font-display)' }}
            >
              Request <span className="text-[#7dd87d]">Investor Packet</span>
            </h1>
            <p className="text-white/70 max-w-xl mx-auto">
              Get detailed information about our hybrid REIT-VC fund structure, current portfolio, and investment opportunities.
            </p>
          </div>
          ...
          <div className="text-center mt-8">
            ...
            <p className="text-white/40 text-xs mt-2">
              By submitting, you agree to receive investment-related communications from ReGen Civics Alliance.
            </p>
          </div>
        </div>
      </main>
