    ...
    <div className="space-y-8">
      ...
      {activeTab === 'profits' && (
        <div className="bg-gradient-to-br from-[#7dd87d]/20 to-[#4a9f9f]/20 rounded-2xl p-8 border border-[#7dd87d]/40 space-y-6">
          <h3 className="text-2xl font-bold text-[#7dd87d] text-center">Portfolio Distributions to $RCivics Holders</h3>
...
export default function Tokenomics() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#1a472a] to-[#0d2818]">
      ...
      {/* How Returns Flow Section */}
      <section className="py-16 px-4">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#7dd87d] mb-4 text-center">
              How Returns Flow
            </h2>
            <p className="text-white/80 text-lg leading-relaxed mb-10 text-center max-w-3xl mx-auto">
              The ReGen Portfolio generates returns from both Land Projects and Alliance Organizations. Resources flow through the network in two distinct ways.
            </p>
            
            {/* Interactive Toggle Section */}
            <HowReturnsFlowToggle />
            
            {/* Callout Box */}
            <div className="mt-12 bg-gradient-to-r from-[#d4a574]/20 to-[#7dd87d]/20 rounded-2xl p-6 border-2 border-[#d4a574]/40 text-center">
              <p className="text-white text-lg leading-relaxed">
                <span className="text-[#d4a574] font-bold">Fees are for those doing the work of managing the fund.</span> <span className="text-[#7dd87d] font-bold">Profits go to those who contribute capital, in all its forms.</span>
              </p>
            </div>
          </div>
        </div>
      ...
      {/* How to Acquire $RCivics Tokens */}
      <section className="py-16 px-4 bg-[#0d2818]/50">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#7dd87d] mb-4 text-center">How to Acquire $RCivics Tokens</h2>
            <p className="text-white/80 text-lg leading-relaxed mb-10 text-center max-w-3xl mx-auto">
              $RCivics tokens represent your proportional claim on fund returns and rewards. There are currently two routes to acquire them.
            </p>
            <div className="grid md:grid-cols-2 gap-6 mb-10">
              <div className="bg-[#1a472a]/60 rounded-2xl p-8 border border-[#d4a574]/40">
                <div className="w-12 h-12 rounded-full bg-[#d4a574]/20 flex items-center justify-center mb-4">
                  <span className="text-2xl">🌱</span>
                </div>
                <h3 className="text-xl font-bold text-[#d4a574] mb-3">Direct Investment</h3>
                <p className="text-white/80 leading-relaxed mb-4">
                  Invest capital directly into the ReGen Civics Fund. $RCivics tokens are issued proportional to your investment, giving you a permanent claim on the fund's success fees and portfolio returns.
                </p>
                <div className="bg-[#0d2818]/50 rounded-lg p-4 text-sm text-white/70">
                  <p className="font-semibold text-white mb-1">Best for:</p>
                  <p>Impact investors, family offices, and individuals seeking long-term exposure to the regenerative economy</p>
                </div>
                <div className="mt-4">
                  <Link href="/opportunity">
                    <Button className="bg-[#d4a574] text-[#1a472a] hover:bg-[#c49060] font-bold w-full">
              ...
              <div className="bg-[#1a472a]/60 rounded-2xl p-8 border border-[#4a9f9f]/40">
                <div className="w-12 h-12 rounded-full bg-[#4a9f9f]/20 flex items-center justify-center mb-4">
                  <span className="text-2xl">🤝</span>
                </div>
                <h3 className="text-xl font-bold text-[#4a9f9f] mb-3">Equity Swap</h3>
                <p className="text-white/80 leading-relaxed mb-4">
                  Land Projects and Alliance Organizations can contribute equity, services, technology, or expertise to the network in exchange for $RCivics tokens. This keeps resources circulating within the ecosystem rather than requiring cash investment.
                </p>
                <div className="bg-[#0d2818]/50 rounded-lg p-4 text-sm text-white/70">
                  <p className="font-semibold text-white mb-1">Best for:</p>
                  <p>Land projects, alliance organizations, and service providers who want to participate in the network's upside</p>
                </div>
                <div className="mt-4">
                  <Link href="/apply">
                    <Button className="bg-[#4a9f9f] text-white hover:bg-[#3a8f8f] font-bold w-full">
            ...
            <div className="bg-[#0d2818]/60 rounded-xl p-6 border border-[#7dd87d]/20 text-center">
              <p className="text-[#7dd87d] font-semibold mb-2">Secondary Market</p>
              <p className="text-white/70 text-sm leading-relaxed">
                $RCivics tokens will be tradeable on secondary markets when available, providing liquidity without requiring project exits. Secondary market access is not yet live. No other acquisition routes are available at this time.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-white/65 leading-relaxed mb-8">
              Much like planting mighty nut-bearing trees is a gift our descendants most benefit from, our efforts to create the foundations for new civilizations will be most enjoyed by those who come after us. The token economic system we are building is not designed to extract value from the movement. It is designed to keep value circulating within it - rewarding those who contribute, backing the token with the land and communities we regenerate, and creating a financial system that is genuinely by the people and for the planet.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Link href="/investor">
                <Button
