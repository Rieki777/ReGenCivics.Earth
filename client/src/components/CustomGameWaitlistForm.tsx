    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            className="bg-white/5 border-white/20 text-white placeholder-white/30 focus:border-[#7dd87d]/50"
          />
        </div>
        <div className="space-y-1.5">
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full bg-white/5 border border-white/20 rounded-lg px-3 py-2 text-white text-sm placeholder-white/30 focus:border-[#7dd87d]/50 focus:outline-none resize-none"
        />
      </div>
