        ...
        <div className="grid md:grid-cols-3 gap-5">
          ...
          >
            ...
            <p className="text-white/50 text-xs mt-3">
              Just the thirteen Season 2 weeks:{" "}
              <a
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 mt-3 text-xs font-semibold text-white/80 hover:text-white bg-red-600/80 hover:bg-red-600 px-3 py-1.5 rounded-lg transition-colors"
            >
