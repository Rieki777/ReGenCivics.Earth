    ...
    <div className="space-y-6">
      ...
      {showNumbers && snap && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          ...
          <Kpi icon={TrendingUp} label="Investors" value={snap.investors.total} sub={`${snap.investors.new} pending review`} attention={snap.investors.new > 0} onClick={() => go("investors")} />
