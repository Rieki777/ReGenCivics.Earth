...
export function LocationPicker({ value, onChange, variant = "dark" }: LocationPickerProps) {
  ...
  const inputClass = isDark
    ? "w-full bg-white/5 border border-white/15 text-white text-sm rounded-xl px-3 py-2 focus:outline-none focus:border-[#7dd87d]/40 placeholder-white/70"
  ...
  const labelClass = isDark ? "text-white/60 text-xs" : "text-[#1a472a]/75 text-xs";
