...
Welcome to the Infinite Game.`,
    ...
    date: 'Jan 30, 2025',
    readTime: '7 min read',
    image: 'https://assets.regencivics.earth/aVsQKWGuwteoFgZN.jpg',
...
To all the Season 1 land stewards: thank you for being the first to play this game with us.`,
    ...
    image: 'https://assets.regencivics.earth/FKGvozofwEQExNFn.jpg',
...
The future of regenerative finance is transparent, participatory, and built on technology that serves life. Welcome to governance that actually works.`,
    ...
    date: 'Jan 31, 2025',
    readTime: '6 min read',
    image: 'https://assets.regencivics.earth/VeoRFkowiirBeXAr.jpg',
...
The regenerative renaissance begins when we remember that organizations exist to serve people, not the other way around.`,
    ...
    date: 'Jan 31, 2025',
    readTime: '5 min read',
    image: 'https://assets.regencivics.earth/qdJyCSVJGfSsRmxE.jpg',
...
The seeds of restoration are already planted. Will you help them grow?`,
    ...
    date: 'Jan 31, 2025',
    readTime: '6 min read',
    image: 'https://assets.regencivics.earth/tqNnBHJUPspoSTxQ.jpg',
...
See you in the game!`,
    ...
    image: 'https://assets.regencivics.earth/blog-games-quests.jpg',
...
We look forward to learning about your project!`,
    ...
    date: 'Feb 2, 2026',
    readTime: '8 min read',
    image: 'https://assets.regencivics.earth/tDFZAkfngdZZObWl.jpg',
...
Learn more about the [Crowd Pooling Tool](https://www.regencivics.earth/crowd-pooling) for launching land projects.`,
    ...
    image: 'https://assets.regencivics.earth/peaZcxlEiltihAJB.jpg',
...
[Create Your Profile Now](/profile)`,
    ...
    date: 'Feb 2, 2026',
    readTime: '3 min read',
    image: 'https://assets.regencivics.earth/cqDpxrSObQEpPwSd.jpg',
...
[Access Investment Thesis](/investor)`,
    ...
    date: 'Feb 5, 2026',
    readTime: '8 min read',
    image: 'https://assets.regencivics.earth/AMrdBIATsoXcSZbO.jpg',
...
*This is a living network. Every project that claims its space makes the whole thing more real. We are glad you are here.*`,
  ...
  },
  {
    ...
    content: `If you've contributed to SEEDS, Hypha, local food systems, regenerative governance experiments, community currencies, and other critical infrastructure for our Regenerative Renaissance and you were never fully compensated for that work, your contributions could live on in ReGen Civics.
