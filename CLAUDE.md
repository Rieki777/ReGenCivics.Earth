...
- `CLAUDE_CODE_PROMPT_2026-04-01_UNIFIED_BUILD.md` — **START HERE.** Unified execution prompt consolidating ALL specs (game system, citizenship tiers, economy pages, fixes, visualizations) into one build plan with 6 tracks. Resolves 10 cross-spec conflicts. Supersedes MEGABATCH and all prior execution prompts. Created 2026-04-01.
