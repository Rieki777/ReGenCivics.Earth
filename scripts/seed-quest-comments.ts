...
When we share our stories, we recognise each other.`,
    comments: [
      ...
      },
      {
        ...
        content: `I came to this through grief, honestly. A river I grew up swimming in ran dry when I was 22. I needed somewhere to put that grief that was not just rage. Regenerative work gave me somewhere to put it that also builds something. That is the whole answer. Post: linkedin.com/posts/example_origin`,
      },
    ],
  },
  {
    ...
    comments: [
      {
        ...
        content: `I planted six native wildflowers along the verge outside my building. Had to check first that it was not illegal in my council (it nearly was). But it is done. My small act of guerrilla rewilding. Post: instagram.com/p/example6. Already inspired my neighbour to do the same.`,
      },
      {
        persona: "Josue Ramirez",
        content: `I spent an hour picking up plastic along a 300-metre stretch of the river near my house. It is something I walk past every day and look away from. Not anymore. Post: x.com/josue_tierra_libre/status/example6. And a commitment to do it monthly.`,
      },
      {
        persona: "Hana Kowalczyk",
        content: `My regenerative act was starting my first compost bin. I have wanted to do this for two years and Quest 3 made me actually do it. It is just a box in the corner of my balcony for now, but it is alive. Shared the setup on TikTok: tiktok.com/@hana_ferments/example6.`,
      },
    ],
  },
  {
...
The more we know our places, the better we can tend them.`,
    comments: [
      ...
      },
      {
        ...
        content: `I am in the west of Ireland in the Connaught blanket bog ecoregion. One of the rarest habitats on Earth and largely destroyed in the 20th century. What surprised me: intact bogs in my county store more carbon per hectare than tropical rainforest. I had no idea. Post: linkedin.com/posts/example7`,
      },
    ],
  },
  {
...
A community that notices its members is a community worth belonging to.`,
    comments: [
      ...
      },
      {
        ...
        content: `I welcomed three people who posted their origin stories this week. One of them is a filmmaker in Lagos working on exactly the kind of land documentation I want to do. We are already planning a collaboration. This is what the platform is for. Post: linkedin.com/posts/example_friends`,
      },
      {
        persona: "Dario Marchetti",
        content: `I answered a question in the forum that had been sitting unanswered for four days. Small thing. But the person replied saying it was the first time they felt like someone had actually seen them on the platform. That is everything. Post: instagram.com/p/example_friends`,
      },
    ],
  },
  {
...
When we name our gifts, they become real. When we witness each other's gifts, a network activates.`,
    comments: [
      ...
      {
        persona: "Baraka Njoroge",
        content: `I am a systems designer and I pledge to apply that lens to the governance challenges that regenerative land projects face. How do you make equitable decisions across a distributed land alliance? That is my question and my gift. Post: x.com/baraka_systems/status/example8`,
      },
      {
        persona: "Clara van den Berg",
        content: `I am a filmmaker and I pledge to document three land projects in the ReGen Civics Alliance over the next year. Real stories, told with care. Stories are how movements move. This is my contribution. Post: linkedin.com/posts/example8`,
      },
    ],
  },
  {
...
This is an invitation to bring others into the vision.`,
    comments: [
      {
        persona: "Dario Marchetti",
        content: `Just finished all four videos and my biggest takeaway is the concept of "coordinating at the speed of trust." We have all the solutions. What we lack is the governance layer to connect them. ReGen Civics is proposing exactly that. Wrote a summary article: medium.com/@dario_regen/example5`,
      },
      {
        persona: "Fatimah Osei",
        content: `Video 3 shifted something in me. The idea that we are not building an organisation but an ecosystem hit differently. I have been in too many movements that became institutions and lost their aliveness. The game framing could be the antidote. Shared on Instagram: instagram.com/p/example5`,
      },
      {
        persona: "Luca Andersson",
        content: `I wrote a short invitation post for my network after watching: "If you have been wondering what regenerative civilisation actually looks like in practice, start here." Three friends have already reached out asking how to join. Post: x.com/luca_regen_north/status/example5`,
      },
    ],
  },
  {
    ...
    comments: [
      {
        ...
        content: `I work adjacent to environmental law and shared this with two firms specialising in land trusts and commons governance. Also reached out to a regenerative agriculture certification body. These are exactly the kinds of organisations the Alliance needs. Post: instagram.com/p/example3`,
      },
      {
        persona: "Sven Lindqvist",
        content: `Shared with a Nordic regenerative finance organisation and a circular economy accelerator. The concept of organisations earning tokens for contributing is exciting to them. Post: linkedin.com/posts/example3`,
      },
      {
        persona: "Amara Diallo",
        content: `I am part of an agroforestry technical assistance network and shared this across our whole community. Probably 30+ organisations. The referral bonus really motivates people to follow through. Post: x.com/amara_agroforestry/status/example3`,
      },
    ],
  },
  {
    ...
    comments: [
      {
        ...
        content: `I sent the link to the folks running Bosque de Luz, a 40-acre food forest project in Costa Rica I have been volunteering with. Also messaged three permaculture groups. Post: instagram.com/p/example2. Fingers crossed they apply.`,
      },
      {
        persona: "Callum Ashford",
        content: `Shared this with the Dartmoor Wilder Grazing project in the UK. They are doing incredible work with mob-grazing and native tree planting. Also sent to two community land trust networks I am part of. Post: x.com/callum_rewild/status/example2`,
      },
      {
        persona: "Preethi Sundaram",
        content: `I run a network connecting small-scale organic farmers across South India and shared this with about 15 project leads in our WhatsApp group. Posted on LinkedIn about the referral bonus too. That alone got a lot of interest. Post: linkedin.com/posts/example2`,
      },
    ],
  },
  {
    ...
    comments: [
      {
        ...
        content: `My dream quest (had this idea at 3am): "The Mycelium Quest." Players map every connection they have to someone doing regenerative work, visualise their personal network as a mycelium diagram, and share it. The value: making invisible connective tissue visible. Post: instagram.com/p/example4`,
      },
      {
        persona: "Kweku Mensah",
        content: `Quest idea: "The Seed Sovereignty Quest." Save seeds from something you grew, document it, and gift them to someone else in the community. Creates living chains of seed stewardship across the Alliance. Post: x.com/kweku_earthgames/status/example4. Already getting traction.`,
      },
      {
