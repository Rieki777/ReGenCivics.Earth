...
const ACTIONS: Action[] = [
  ...
  { slug: "refer-land-project", title: "Refer a land project that gets shortlisted", description: "Use the Share button to send a land project your referral link. This verifies when their application is shortlisted for Season 2.", points: 100, proofType: "referral_shortlisted", sortOrder: 3 },
  ...
  { slug: "food-foresting", title: "Complete the Food Foresting quest", description: "Complete the existing Food Foresting quest once. This verifies automatically from your quest history.", points: 40, proofType: "game_quest", linkedQuestId: "quest-14", sortOrder: 5 },
