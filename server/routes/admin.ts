...
import { ENV } from "../_core/env"; import { getOpsNotifyChannelStatus } from "../_core/opsNotifyStatus";  // Fallback declarations keep the pulse aggregate compatible with the main router shape. var liveEventIds: number[] = []; var pastEventsNoWatch = 0; var reminderCronIssues = 0;
