...
export function serveStatic(app: Express) {
  ...
  const ROUTE_META: Record<string, { title: string; description: string; image?: string }> = {
    ...
    "/ship":        { title: "The ReGen Ship: Sail Cascadia, Plant As You Go", description: "A regenerative pirate ship you can book: voyages through Cascadia with a treasure chest of seeds. Book a voyage or enter the Maiden Voyage Quest." },
  };
