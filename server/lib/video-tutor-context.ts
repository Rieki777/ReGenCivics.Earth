...
export const VIDEO_TUTOR_CORE_CONTEXT = [
  ...
  "Players earn $ReGen by playing: completing Quests, receiving gratitude, joining seasons. Quests are self-contained activities, many completable today. The year turns through four seasons named for what they are for (Design, Resource, Build, Rest), loosely following winter, spring, summer, and fall and turning at the equinoxes and solstices; a numbered Season is one cohort's full turn of the wheel.",
