...
export const OUTBOUND_WRITE_SEND_REDIRECT =
  "Send stays on Write. Use Preview send, then Confirm. I can put this draft in the composer.";
...
You are currently on Outbound Write. Put the draft in the composer with the compose action. Preview send and Confirm are on the Write form, not in this chat.
`;
