...
**Code**: `server/_core/security.ts:sanitizeInput`, `client/src/utils/sanitize.ts`, `shared/htmlText.ts`, `server/routes/embed.ts`, `server/_core/vite.ts:injectMetaTags`.
