...
| F2 — map shell escape (fix) | game-amora | `wt-fix-map` / `wt/fix-map-shell` | dispatched ~02:40 EDT (**1st handle**) | `LivingMap.tsx` ONLY | dispatched; **HIGH** (V-H2); lands FIRST | ≥5f3cf0b | at dispatch |
