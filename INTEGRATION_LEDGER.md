...
| **L1 — module library flow** (round 4) | game-amora | `C:/Users/taren/Desktop/Amora/wt-r4-library` / `wt/r4-library` | background agent, dispatched 2026-08-21 ~09:05 EDT from `def4b18` | brief + amendments: `/modules` pages, `navGroups` filter + `TAB_MODULE`, Go-live card, `shared/moduleCatalog.ts`, `shared/modules.ts` fields + renames, `/api/modules` blocks; no migration | dispatched | def4b18 (base) | — |
| **L2 — How Power Is Held** (round 4) | game-amora | `C:/Users/taren/Desktop/Amora/wt-r4-power` / `wt/r4-power` | background agent, dispatched 2026-08-21 ~09:07 EDT from `def4b18` (R35 override: without map-org's archetypes) | brief + amendments: VillageMap rebuild per the 14-point spec, shape/decides-by/domains, vision block on drafts, currency (CHF/CRC/user display), `org.declare` + `represents_circle` ADR, migration **0083** | dispatched | def4b18 (base) | — |
