...
| F4 — server hygiene (fix) | game-amora | `wt-fix-server` / `wt/fix-server-hygiene` | dispatched ~02:40 EDT (**3rd handle**) | index.ts header/route-shell zones, seeds, Mint page | dispatched; L-M1 headers, L-M2 quest images, L-M3 mint, L-L1/L5/L6 | ≥5f3cf0b | at dispatch |
