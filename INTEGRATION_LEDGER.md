...
| **L5b — calendar community** (round 4) | game-amora | `C:/Users/taren/Desktop/Amora/wt-r4-calendar2` / `wt/r4-calendar-community` | background agent, dispatched 2026-08-21 ~09:09 EDT from `def4b18` | brief + amendments: waitlist, slots, meet-me, layer UI, who-is-here, print, weekly zero-token brief (+ agent inbox delivery), `setOpportunitiesProvider`, migration **0088** | dispatched | def4b18 (base) | — |
