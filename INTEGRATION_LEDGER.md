...
| **L8 — three persona QA passes** (round 4, R31) | live 335058f | `wt-r4-qa1/2/3` (scripts only) | three background agents, dispatched 2026-08-21 ~15:50 EDT | persona 1 first-time visitor (anonymous); persona 2 new member (QA token, GET/render only); persona 3 founder (writes on a LOCAL build only) | dispatched; reports land in `round4/qa/persona-N/` (coordinator commits) | 335058f | — |
